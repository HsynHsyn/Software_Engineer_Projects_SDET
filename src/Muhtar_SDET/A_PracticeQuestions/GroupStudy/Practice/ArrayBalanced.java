...
public class ArrayBalanced {
    public static void main(String[] args) {
        ...
        System.out.println(isArrayBalanced(new int[] {4, 1, 2, 0 ,3, 4}, 6));
    }
...
An array is balanced if the sum of elements on the left side of any element in the array is
equal to the sum of elements on the right side.
