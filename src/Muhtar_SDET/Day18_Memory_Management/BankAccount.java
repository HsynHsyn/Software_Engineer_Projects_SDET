...
public class BankAccount {
    ...
    public long accountNumber; // it contains digit and longer than integer
    public double balance; // we can give a value like balance =1000;
    ...
    public String toString() {
        return "BankAccount{" +
                ...
                ", balance= $" + balance + // we added $ symbol
                '}';
    }
